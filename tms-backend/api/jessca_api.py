    ...
    try:
        ...
        if result['success'] and result['output_path']:
            ...
            return {
                ...
                "amount_words_count": result.get('amount_words_count', 0),
                "amount_words_matched_count": result.get('amount_words_matched_count', 0),
                "amount_words_issue_count": result.get('amount_words_issue_count', 0),
