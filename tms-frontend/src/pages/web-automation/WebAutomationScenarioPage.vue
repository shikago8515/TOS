...
function showRunRequirementDialog(rawMessage: string): false { const localized = text(rawMessage); messageTone.value = 'warning'; message.value = localized; statusLabel.value = '待命'; statusText.value = localized; lastResult.value = { ok: false, message: localized }; window.alert(localized); return false }
