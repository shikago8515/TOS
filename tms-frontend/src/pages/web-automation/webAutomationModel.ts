...
const automationLauncherBaseUrl = 'http://127.0.0.1:3210'

export function buildAutomationProxyBaseUrl(appId: string): string {
  return `${automationLauncherBaseUrl}/api/apps/${encodeURIComponent(appId)}/proxy`
}
...
export const webAutomationEntries: WebAutomationEntry[] = [
  {
    ...
    executorBaseUrl: buildAutomationProxyBaseUrl('microsoft-login-n8n-demo'),
  ...
  },
  {
    ...
    title: 'VENT',
    subtitle: 'Infor Nexus 自动化',
    description: '进入 https://network.infornexus.com，后续承接 VENT 本地直连浏览器自动化链路。',
  ...
  },
  {
    ...
    title: 'YUEN TAI+XO',
    subtitle: 'Infor Nexus 自动化',
    description: '进入 https://network.infornexus.com，后续承接 YUEN TAI+XO 本地直连浏览器自动化链路。',
    appId: 'shipping-automation-demo',
    executorBaseUrl: buildAutomationProxyBaseUrl('shipping-automation-demo'),
    localExecutorToken: 'local-shipping-automation-72fd26f0f3b54db49c619bbda2be0f8f',
    webhookUrl: 'https://network.infornexus.com',
    routePath: '/web-automation/scenarios/xinlongtai-shipping-automation',
    tags: ['YUEN TAI', 'XO', 'Shipping', 'InforNexus'],
    status: 'online',
  },
  {
    ...
    tags: ['Trade Card', 'INV amount', 'VENT', 'YUEN TAI'],
    status: 'online',
  },
  {
    id: 'xo-tc-inv-automation',
    title: 'XO-Trade Card INV amount',
    subtitle: 'XO-Trade Card INV amount 自动化',
    description: 'XO-Trade Card INV amount 出货明细与费用录入自动化。',
    appId: 'shipping-automation-demo',
    executorBaseUrl: buildAutomationProxyBaseUrl('shipping-automation-demo'),
    localExecutorToken: 'local-shipping-automation-72fd26f0f3b54db49c619bbda2be0f8f',
    webhookUrl: 'https://network.infornexus.com',
    routePath: '/web-automation/scenarios/xo-tc-inv-automation',
    tags: ['Trade Card', 'INV amount', 'XO'],
    status: 'online',
  },
  {
  ...
  },
  {
    ...
    subtitle: 'Excel 箱单批量下载',
    description: '上传 Excel 后按 PO 号查询箱单并发起下载，保存到指定本机目录。',
    appId: 'shipping-automation-demo',
    executorBaseUrl: buildAutomationProxyBaseUrl('shipping-automation-demo'),
    localExecutorToken: 'local-shipping-automation-72fd26f0f3b54db49c619bbda2be0f8f',
    webhookUrl: 'https://network.infornexus.com',
    routePath: '/web-automation/scenarios/packing-list-auto-download',
    tags: ['Packing List', 'Download', 'InforNexus'],
    status: 'online',
  },
  {
    id: 'infornexus-sync',
    ...
    executorBaseUrl: buildAutomationProxyBaseUrl('infornexus-sync'),
    localExecutorToken: '',
  ...
  },
  {
    ...
    executorBaseUrl: buildAutomationProxyBaseUrl('email-report-bot'),
    localExecutorToken: '',
  ...
  },
  {
    ...
    executorBaseUrl: buildAutomationProxyBaseUrl('form-auto-fill'),
    localExecutorToken: '',
