...
export const tosNavParents = [
  ...
  {
    id: 'tms-finance-processing',
    label: 'TMS财务表格数据处理',
    labelEn: 'TMS Finance Processing',
    group: 'excel',
    order: 56,
  },
  {
...
export const tosModules = [
  ...
  },
  {
    ...
    title: 'IT-发票PDF重排序',
    navLabel: 'IT-发票PDF重排序',
    navLabelEn: 'IT Invoice PDF Reorder',
    group: 'excel',
    stage: 'production',
  ...
  },
  {
    ...
    group: 'excel',
    navParentId: 'tms-finance-processing',
    stage: 'validation',
    description: '从 Sample/Bulk 来源文件回填内销对账大表尾部已有行',
    descriptionEn: 'Backfill existing internal reconciliation rows from Sample/Bulk source files',
    order: 56,
  },
  {
    ...
    title: 'Work Sales 数据提取',
    navLabel: 'Work Sales 数据提取',
    navLabelEn: 'Work Sales Extract',
    group: 'excel',
    navParentId: 'tms-finance-processing',
    stage: 'validation',
    description: '从 iPlix Turnover Details 和补充参考表生成 Work Sales 汇总',
    descriptionEn: 'Generate Work Sales summary from iPlix Turnover Details and reference data',
    order: 57,
  },
  {
    id: 'browser-plugins',
