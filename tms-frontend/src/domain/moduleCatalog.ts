...
export const tosModules = [
  ...
  },
  {
    ...
    title: 'Jason / Invoice 自动下载',
    titleEn: 'Jason / Invoice Auto Download',
  ...
  },
  {
    ...
    title: 'Work Sales 数据写入',
    titleEn: 'Work Sales Data Fill',
    navLabel: 'Work Sales 数据写入',
    navLabelEn: 'Work Sales Fill',
    group: 'finance-excel',
    category: 'excel',
    stage: 'validation',
  ...
  },
  {
    ...
    title: 'iPlex 双表核对',
    titleEn: 'iPlex Dual Table Compare',
    navLabel: 'iPlex 双表核对',
    navLabelEn: 'iPlex Compare',
    group: 'finance-excel',
    category: 'excel',
    stage: 'validation',
