...
export function createXoTcInvAutomation(deps) {
  ...
  async function handleRequest(body) {
    ...
    const activeRun = registerActiveRun({
      ...
      chargeCode: firstInvoiceAdjustments?.chargeCode || (firstInvoiceAdjustments?.noCharge ? "" : "ZEQS"),
      noCharge: Boolean(firstInvoiceAdjustments?.noCharge),
    ...
    try {
      ...
      recordCompletedRun({
        ...
        chargeCode: result.buildAdjustmentResult?.zeqs?.reason?.code || firstInvoiceAdjustments?.chargeCode || (firstInvoiceAdjustments?.noCharge ? "" : "ZEQS"),
        noCharge: Boolean(result.buildAdjustmentResult?.noCharge || firstInvoiceAdjustments?.noCharge),
