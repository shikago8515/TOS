...
export async function runTicketOwnerStatisticsWorkflow(deps, { runOptions, body, moduleDefinition, reportProgress }) {
  ...
  const loginResult = await deps.runLogin([], {
    ...
    detailConcurrency: normalizePositiveInteger(body?.detailConcurrency, 6),
    ...
    diagnoseAppSources: body?.diagnoseAppSources === true,
    diagnoseSkipODataLookup: body?.diagnoseSkipODataLookup === true,
